...
class PanSteps extends StatefulWidget{

  // 接口回调
  Base_Class base_class;

  PanSteps({Key key,@required this.base_class}):super(key: key);

  @override
  State<StatefulWidget> createState() {
    return PanStepsState()
      ..base_class = base_class;
  }
}

class PanStepsState extends BaseState<PanSteps>{
                      ...
                      onTap: (){
                        if(this.isEditor){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) =>
                              PanFolders(panid: list[index].id, type: 2, name: list[index].name)
                          ));
                        }
                      },
                      child: Container(
