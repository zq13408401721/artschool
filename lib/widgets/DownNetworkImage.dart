...
import 'package:yhschool/widgets/DownImageProvider.dart';
...
class DownNetworkImage extends StatelessWidget {
  ...
  static Future evictFromCache(
    ...
    return DownImageProvider(url, scale: scale).evict();
  }

  final DownImageProvider _image;
