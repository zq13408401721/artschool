 ...
 * 视频条目
 */
class SchoolVideoChoiceTile extends StatelessWidget{
  ...
  SchoolVideoChoiceTile({Key key,@required this.data,@required this.title, @required this.showTitle=true}):super(key: key);
            ...
            child: Stack(
              children: [
                ClipRRect(
                  ...
                  child: CachedNetworkImage(imageUrl:data.cover,fit: BoxFit.cover,width: double.infinity,),
                ),
                /*Positioned(
                  top: 0,
                  bottom: 0,
