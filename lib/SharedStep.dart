...
import 'bean/shared_teacher_pan_list_bean.dart';

class SharedStep extends StatefulWidget{

  SharedStep({Key key}):super(key: key);

  @override
  State<StatefulWidget> createState() {
    return SharedStepState();
  }

}

class SharedStepState extends BaseState<SharedStep>{
