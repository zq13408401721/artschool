...
import 'package:yhschool/PanFolders.dart';
...
class PanImages extends StatefulWidget{

  // 接口回调相关类
  Base_Class base_class;

  PanImages({Key key,@required this.base_class}):super(key: key);

  @override
  State<StatefulWidget> createState() {
    return PanImagesState()
      ..base_class = base_class;
  }
}

class PanImagesState extends BaseState<PanImages>{
                    ...
                    onTap: (){
                      if(this.isEditor){
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context) =>
                            PanFolders(panid: list[index].id, type: 1, name: list[index].name)
                        ));
                      }
                    },
                    child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                        ...
                                        child:Text(list[index].name,maxLines:1,overflow:TextOverflow.ellipsis,style: TextStyle(fontSize: Constant.isPad ? ScreenUtil().setSp(32) : ScreenUtil().setSp(42)),)
                                    )
                                  ],
                                ),
                              ),
