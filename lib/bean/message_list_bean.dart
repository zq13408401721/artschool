/// errno : 0
/// errmsg : ""
/// data : [{"id":2,"fromuid":"b4e4909f-6cf3-497e-981b-13449e438ea3","touid":"e82cf39e-dfa1-45db-90dc-f5a6035a3b15","content":"课后作业素描","time":"2021-10-22 14:03:05","relationid":1,"fromusername":"student1","fromnickname":"系统测试","fromavater":null,"tousername":"test00014","tonickname":"test_student1","toavater":"http://res.yimios.com:9050/user/small/e82cf39e-dfa1-45db-90dc-f5a6035a3b15/IMG_0001.png"},{"id":1,"fromuid":"b4e4909f-6cf3-497e-981b-13449e438ea3","touid":"e82cf39e-dfa1-45db-90dc-f5a6035a3b15","content":"课后作业是否完成？","time":"2021-10-22 13:11:22","relationid":1,"fromusername":"student1","fromnickname":"系统测试","fromavater":null,"tousername":"test00014","tonickname":"test_student1","toavater":"http://res.yimios.com:9050/user/small/e82cf39e-dfa1-45db-90dc-f5a6035a3b15/IMG_0001.png"}]
...
class MessageListBean {
  ...
  MessageListBean.fromJson(dynamic json) {
    _errno = json['errno'];
    _errmsg = json['errmsg'];
    if (json['data'] != null) {
      _data = [];
...
class Data {
  ...
  String get fromavater => _fromavater;
