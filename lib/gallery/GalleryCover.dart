...
class GalleryCover extends StatelessWidget{
  ...
  Data category;
  String smallurl = "";
  GalleryCover({Key key,@required this.category}):super(key: key){
    smallurl = Constant.parseNewGallerySmallString(this.category.cover,category.width,category.height);
  }
