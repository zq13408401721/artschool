...
class AccountStage extends StatelessWidget{

  String url;
  String title;
  bool ishttp=false;
  //WebViewController _webViewController;
  AccountStage({Key key,@required this.url,@required this.title}):super(key: key);
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Text("$title",style: TextStyle(fontSize: SizeUtil.getAppFontSize(30))),
                  ),
                )
              ],
            ),
                ...
                child: Container(
                  ...
                  child:Center(
                    child: Column(
                      ...
                      children: [
                        /*Text("免费获取体验帐号",style: TextStyle(fontSize: SizeUtil.getAppFontSize(60),color: Colors.red,fontWeight: FontWeight.bold),),
