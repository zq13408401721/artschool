...
class ColumnListPage extends StatefulWidget{
  ...
  ColumnListPage({Key key}):super(key: key);

  @override
  State<StatefulWidget> createState() {
    return ColumnListPageState();
  }
}

class ColumnListPageState extends BaseRefreshState<ColumnListPage>{
   ...
   * 切换专题列表分类
   */
  void updateColumnList(int type){
    this.type = type;
    setState(() {
      list.clear();
    });
